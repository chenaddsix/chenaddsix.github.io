...
<div align=center> <img src="https://calebchen-1256449519.cos.ap-guangzhou.myqcloud.com/18.04/Investigation_meta_learning_3.png"  alt=" " width="70%"/>  </div>
<div align=center>Fig 3. Prototypical Network on few-shot and zero-shot scenarios </div>

伪代码如下：
代码中的$$d$$采用了Bregman divergence，实验证明效果优于cosine distance。
<div align=center> <img src="https://calebchen-1256449519.cos.ap-guangzhou.myqcloud.com/18.04/Investigation_meta_learning_4.png"  alt=" " width="80%"/>  </div>

### Gradient Descent

基于梯度的方法中，最流行的meta learning方法如Google在16年发表的[3]，这类方法会构建一个meta learner和learner两个部分，meta learner负责学习一个更新learner的策略或者直接是网络参数

<div align=center> <img src="https://calebchen-1256449519.cos.ap-guangzhou.myqcloud.com/18.04/Investigation_meta_learning_5.png"  alt=" " width="50%"/>  </div>
<div align=center>Fig 4. LSTM Optimizer </div>

<div align=center> <img src="https://calebchen-1256449519.cos.ap-guangzhou.myqcloud.com/18.04/Investigation_meta_learning_6.png"  alt=" " width="60%"/>  </div>
<div align=center>Fig 5. Computational graph used for computing the gradient of the optimizer. </div>
...
<div align=center> <img src="https://calebchen-1256449519.cos.ap-guangzhou.myqcloud.com/18.04/Investigation_meta_learning_11.png"  alt=" " width="70%"/>  </div>

[3],[14],[15]都是从deep learning的角度来求解最优的更新的策略，而[12]从强化学习的角度来解释更新策略的求解，算法模型如下：

<div align=center> <img src="https://calebchen-1256449519.cos.ap-guangzhou.myqcloud.com/18.04/Investigation_meta_learning_10.png"  alt=" " width="70%"/>  </div>
...
<div align=center> <img src="https://calebchen-1256449519.cos.ap-guangzhou.myqcloud.com/18.04/Investigation_meta_learning_7.png"  alt=" " width="50%"/>  </div>
...
<div align=center> <img src="https://calebchen-1256449519.cos.ap-guangzhou.myqcloud.com/18.04/Investigation_meta_learning_8.png"  alt=" " width="50%"/>  </div>
<div align=center>Fig 6. Diagram of MAML. </div>
...
<div align=center> <img src="https://calebchen-1256449519.cos.ap-guangzhou.myqcloud.com/18.04/Investigation_meta_learning_9.png"  alt=" " width="70%"/>  </div>
<div align=center>Fig 7. The operation of the memory module on a query q with correct value v. </div>
...
<div align=center> <img src="https://calebchen-1256449519.cos.ap-guangzhou.myqcloud.com/18.04/Investigation_meta_learning_15.png"  alt=" " width="70%"/>  </div>
<div align=center>Fig 9. The network architecture of A3C in [19]. </div>
...
<div align=center> <img src="https://calebchen-1256449519.cos.ap-guangzhou.myqcloud.com/18.04/Investigation_meta_learning_14.png"  alt=" " width="70%"/>  </div>
...
<div align=center> <img src="https://calebchen-1256449519.cos.ap-guangzhou.myqcloud.com/18.04/Investigation_meta_learning_13.png"  alt=" " width="70%"/>  </div>
